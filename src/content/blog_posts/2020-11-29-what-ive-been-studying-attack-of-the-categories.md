...
description: 'A Thanksgiving-break tour through category theory, algebraic topology, and whatever else I was studying.'
...
- I also reviewed the idea of **free abelian groups**, which are defined in a linear algebraic fashion but turn out to be isomorphic to copies of $\mathbb Z$, which I proved as an exercise. Furthermore, they have a _basis_ that generates the group, and every basis has the same amount of elements.
...
- Finally, over winter I plan to read chapter 5 of Pugh's _Analysis_ (the section on multivariate analysis), in preparation for my differential topology and Riemannian geometry courses next semester.
