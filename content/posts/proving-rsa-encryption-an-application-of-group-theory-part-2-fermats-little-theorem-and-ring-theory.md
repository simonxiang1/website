---
date: 2020-07-17
title: "(Archive) Proving RSA Encryption: An Application of Group Theory (Part 2: Fermat's Little Theorem and Ring Theory)"
draft: false
---
<p>
...
- $\mathscr{G}_1$ (Associativity): For all $a, b, c \in G,$ we have $(a+b)+c = a+(b+c)$.
- $\mathscr{G}_2$ (Identity): There exists an element $0 \in G$ such that for all $a \in G,$ we have $0+a=a+0=a.$
- $\mathscr{G}_3$ (Inverse): For all $a \in G$, there exists an $a' \in G$ such that $a + a' = a' + a = 0.$
</p>
