---
date: 2020-08-05
title: "(Archive) Linear Algebra and Its Applications, Part 2: Derivatives"
draft: false
---
<p>
...
\begin{pmatrix}
   ...
   0 & 0 & 0 & 0 & 0 & 0 \\ 
   \end{pmatrix}, \] where $\dim (\mathbb{R}[x]) = n+1$ (or $\mathbb{R}[x]$ having polynomials of a maximum degree $n$). You can multiply this matrix by some polynomial vectors in your free time to see if this really works. 
</p>
<p>
